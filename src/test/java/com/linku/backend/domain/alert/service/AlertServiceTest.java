...
class AlertServiceTest {
    ...
    void getMyAlerts_returnsAlertsSuccessfully() {
        ...
        when(alertRepository.findByDepartmentConfigIdInOrderByPostTimeDesc(anyList())).thenReturn(List.of(alert));
        ...
        verify(alertRepository).findByDepartmentConfigIdInOrderByPostTimeDesc(List.of(1L));
    }
    ...
    void getMyAlerts_returnsEmptyList_whenNoSubscriptions() {
        ...
        verify(userRepository).findById(1L);
        verify(subscribeRepository).findByUser_UserIdOrderByDepartmentConfig_IdAsc(1L);
        verify(alertRepository, times(1)).findByDepartmentConfigIdInOrderByPostTimeDesc(Collections.emptyList());
    }
}
